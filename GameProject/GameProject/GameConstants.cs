...
namespace GameProject
{
    ...
    public static class GameConstants
    {
        ...
        public static readonly Vector2 GAMESTRING_LOCATION =
            new Vector2(WINDOW_WIDTH / 2 - (2 * DISPLAY_OFFSET), WINDOW_HEIGHT / 2 - 15);
        public static readonly Vector2 HELP_LOCATION =
            new Vector2(350, WINDOW_HEIGHT / 2 - 15);
        public static readonly Vector2 HELP2_LOCATION =
            new Vector2(525, WINDOW_HEIGHT / 2 + 20);
